...
printf "  If you need to create a fine grained personal access token, see here for instructions:\\n" 
printf "https://docs.github.com/en/authentication/keeping-your-account-and-data-secure\\\n"
printf "/creating-a-personal-access-token#creating-a-fine-grained-personal-access-token"
